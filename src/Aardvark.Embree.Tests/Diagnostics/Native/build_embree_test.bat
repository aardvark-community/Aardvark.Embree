@echo off
REM Build script for Embree instance test
...
:build
echo.
echo Building embree_instance_test.cpp...
echo.
...
cl.exe /EHsc /W3 /I"%EMBREE_INCLUDE%" embree_instance_test.cpp /link /LIBPATH:"%EMBREE_LIB%" embree4.lib tbb12.lib
