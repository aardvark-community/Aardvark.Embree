@echo off
REM Build script for Embree interpolate reference test
...
:build
echo.
echo Building embree_interpolate_reference.cpp...
echo.
...
cl.exe /EHsc /W3 /I"%EMBREE_INCLUDE%" embree_interpolate_reference.cpp /link /LIBPATH:"%EMBREE_LIB%" embree4.lib tbb12.lib
